...
if __name__=="__main__":
    ...
    parser.add_argument('--save_dir', type=str, help='saving directory',default="/data/public_dataset/waymo/STrajNet_preprocessed_data/")
    parser.add_argument('--file_dir', type=str, help='Dataset directory',default="/data/public_dataset/waymo/uncompressed/tf_example")
    ...
    with Pool(NUM_POOLS) as p:
        #p.map(process_training_data, train_files[:60])
        p.map(process_training_data, train_files[60:300])
